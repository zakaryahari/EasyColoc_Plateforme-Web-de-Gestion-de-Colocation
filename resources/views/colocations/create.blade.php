...
<head>
    ...
    <title>Start a New House</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body class="bg-slate-900 min-h-screen flex items-center justify-center">
    <div class="max-w-md w-full mx-auto px-4">
        <div class="bg-slate-800 rounded-2xl p-8 border-2 border-slate-700">
            <h1 class="text-3xl font-bold text-white mb-2">Start a New House</h1>
            <p class="text-slate-400 mb-8">Create your colocation and become the owner</p>
            ...
            <form action="{{ route('colocations.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    <label for="name" class="block text-sm font-medium text-slate-300 mb-2">House Name</label>
                    <input type="text" 
                           name="name" 
                           id="name" 
                           required
